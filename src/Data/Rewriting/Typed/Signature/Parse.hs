...
module Data.Rewriting.Typed.Signature.Parse
    ( parse
    ) where


import Data.Rewriting.Typed.Signature.Type
import Data.Rewriting.Typed.Utils.Parse (lex, boxBrackets, ident)
import Data.Rewriting.Typed.Datatype.Parse (parseDatatypeName)
...
checkDts       :: MonadFail m => [String] -> m String -> m String
